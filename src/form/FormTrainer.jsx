...
export default function FormTrainer({ setSelect,selectItem }) {
    ...
    const handleSubmit = async (e) => {
        ...
        formData.append('id', selectItem?selectItem.id?selectItem.id:0:0);
    ...
    return (
        <div id="equipmentAddModal" class="modal">
            <div class="modal-content entity-add-form">
                ...
                <form class="trainer-form"  onSubmit={handleSubmit}>
                    ...
                    <div class="input-group">
                        ...
                        <div>
                            ...
                            <input type="date" id="trainerAge" value={trainerAge} onChange={(e) => setTrainerAge(e.target.value)} required />
                        </div>
                    ...
                    <button class="add-button" type="submit">Add Trainer</button>
                </form>
