    ...
    <>
      ...
      <div className="body-container">
        <div
          className="banner"
          style={{
            backgroundImage: `url(${process.env.PUBLIC_URL}/img/victor-freitas-WvDYdXDzkhs-unsplash.jpg)`,
          }}
        >
          <div className="banner-content">
            <div className="tag-line">
              <span>Get Healthy Body</span>With the Perfect Exercises
            </div>
        ...
        <div className="container-1">
          <div className="text-line">
            ...
            <p>
              ...
              to fit your needs, whether you are a experienced athlete. We
              believe that everyone Should have access to the benefits of
              exercise make it happen. Lorem ipsum dolor sit amet, consectetur
              adipisicing elit. Corrupti, recusandae ullam. Minima sunt nemo
              molestiae nulla blanditiis, odit beatae quidem perferendis ullam
        ...
        <div className="container-2">
          ...
          <div className="cart-container">
            ...
            <div className="p-carts">
              ...
              <p>
                Our trainers will design thot a progressive workout plans that
            ...
            <div className="p-carts">
              ...
              <h3>Basic Yoga</h3>
              <p>
                This combines with cardio & Strength training to help lose
                weight & fitness.
              </p>
            </div>
          </div>
        </div>
        <div className="container-2 b" id="member">
          <div className="con-heading">
            <h2>Choose The Best Plan </h2>
            <p>
              Choose a plan that's right far your growing team. Simple pricing &
              NO hidden charges.
            </p>
          </div>
        ...
        <div className="info-container">
          <div className="footer-box" id="about">
            ...
            <p>
              ...
              metus euismod, interdum velit in, scelerisque ligula. Ut in tellus
              ac enim aliquam laoreet eu at eros. Donec euismod dignissim orci
              id vestibulum.
            </p>
          </div>
            ...
            <div className="contact-details">
              <table>
                ...
                <tr>
                  ...
                  <td className="td-raw">
                    {" "}
                    Monday to Saturday <br /> 9:00 AM to 6:00 PM
                  </td>
                </tr>
              </table>
            </div>
